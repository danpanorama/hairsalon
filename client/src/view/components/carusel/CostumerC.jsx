      ...
      <Carousel  className="carusel"  activeIndex={index} onSelect={handleSelect}>
        <Carousel.Item className='flexcenter'>
          ...
          <div className="circulimg">
            ...
            <p className='txtblack over bgwhite'>בואו נתחיל שהשירות והיחס של סמיה מעל ומעבר לכל ציפייה !
התוספות שיער באיכות נדירה ממליצה בחום</p>
  ...
  {/* </div> */}
          ...
          <div className="circulimg">
            ...
            <p className='txtblack over bgwhite'>חייבת להגיד שניסיתי תוספות לפני אבל על השיטה של סמיה באמת שאין בלי דבק בלי כאבים חבל על הזמן לא
...
ממולץץ מאודד</p>
        ...
        <Carousel.Item>
          ...
          <div className="circulimg">
            ...
            <p className='txtblack over bgwhite'>אין עלייך סאמו אני חייבת לציין שפעם ראשונה שאני שמה תוספות שהם לא הלחמה ולא דבק ולא חרוזים ואני מרוצה אני כבר שנה וחצי איתם לא רואים שאני עם תוספות זה נראה לגמרי טבעי, והאיכות של השיער אין דברים כאלה!! אני מסרקת חופפת וכלום לא מציק לי  זמן רב אני עם תוספות ותמיד הורדתי בגלל הרסתות עכשיו אין רסתות וכלום לא מציק לי התוספות הכי נוחות הם רק אצלך  והשיטה שאת המצאת היא השיטה הכי נוחה ממליצה בחוםםםם אוהבת אותך מאוד מי שלא מנסה מפסיד בגדולללל 👌</p>
